...
{
    const char* pszTimestamp = "My name is 77 - My Own Bitdiamond 2026-04-07";
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256(); // 938343
        ...
        // m_assumeutxo_data disabled due to constexpr limitations on MSVC
        // Uncomment when upgrading MSVC or switching to runtime initialization
        m_assumeutxo_data = {};
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            //使用十六进制的“My name is 77"作为默认的signet挑战
            bin = "5121034d796e616d656973373752ae"_hex_v_u8;
